...
CREATE TABLE crew (
	...
	las'TN'ame varchar(50) NOT NULL,
	firs'TN'Ame varchar(50) NOT NULL,
...
/* 
    Order of data:
    las'TN'ame, firs'TN'ame, address, city, state, zipCode, phone, email  
*/

INSERT INTO Passenger(lastname, firstname, address, city, state, zipCode, phone, email)VALUES
...
/* 
    ...
    las'TN'ame, firs'TN'ame, address, city, state, zipCode, phone, email 
*/
INSERT INTO Crew(lastname, firstname, address, city, state, zipCode, phone, email) VALUES
